...
- **Reasoning & Thinking**: Auto-enables reasoning for capable models (Anthropic Claude 4.6 Haiku, OpenAI GPT-5.4 Mini, Gemini 3.1 Flash, DeepSeek R1) with native support for streaming `reasoning` events. Custom configuration is also supported via `litellm_kwargs`.
