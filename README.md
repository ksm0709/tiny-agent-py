...
- **Reasoning & Thinking**: Auto-enables reasoning for capable models (Anthropic Claude 3.7, OpenAI o1/o3, DeepSeek R1, Gemini 2.0 Flash Thinking) with native support for streaming `reasoning` events. Custom configuration is also supported via `litellm_kwargs`.
